...
## Corpus Check
- 16 files · ~20,701 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 298 nodes · 430 edges · 19 communities (16 shown, 3 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e02faf5b`
...
2. `reregister_all_shortcuts()` - 13 edges
3. `AppState` - 11 edges
4. `Snippet` - 10 edges
...
### Community 0 - "main.js"
Cohesion: 0.02
Nodes (67): addBtn, appSettings, appWindow, autoPasteToggle, bulkActionBar, bulkCancelBtn, bulkDeleteBtn, bulkStackBtn (+59 more)
...
### Community 2 - "lib.rs"
Cohesion: 0.16
Nodes (35): Result, Option, Snippet, AppState, capture_foreground_window(), capture_target(), clear_all_data(), copy_and_paste() (+27 more)
...
Cohesion: 0.24
Nodes (14): Default, PathBuf, default_snippet_type(), get_app_dir(), get_settings_path(), get_snippets_path(), load_settings(), load_snippets() (+6 more)
...
## Knowledge Gaps
- **120 isolated node(s):** `name`, `private`, `version`, `type`, `tauri` (+115 more)
